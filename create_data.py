""" 
Run this file to generate your own dataset Star size predictor app
- Change the number of samples as per your wish and run this file
...
#Define a seed value(other than 100,it was used for training)
np.random.seed(5007)
